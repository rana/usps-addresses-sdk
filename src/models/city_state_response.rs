...
/// CityStateResponse : The validated ZIP Code&#8482; for a given city and state.
...
impl CityStateResponse {
    /// The validated ZIP Code&#8482; for a given city and state.
    pub fn new() -> CityStateResponse {
        CityStateResponse {
            city: None,
            state: None,
        }
